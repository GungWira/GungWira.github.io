...
function setUpContent(){
  ...
  setTimeout(() => {
    for(let i=0; i<overlayChildren.length; i++){
      ...
      setTimeout(() => {
        overlayChildren[2].style.animationName = "shake-lentera"
        overlayChildren[3].style.animationName = "shake-lentera"
        overlayChildren[4].style.animationName = "shake-lentera"
