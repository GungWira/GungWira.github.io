...
const imgTextWelcome = document.querySelector(".welcome-section .text-welcome-section img")
...
function setUpContent(){
  ...
  setTimeout(() => {
    for(let i=0; i<overlayChildren.length; i++){
      ...
      imgTextWelcome.classList.add("showOff")
      welcomeText = setInterval(setTextWelcome, 100)
      setTimeout(() => {
        setMinorTextWelcome()
      }, 1000);
      setTimeout(() => {
        overlayChildren[5].style.animationName = "shake-lentera"
        overlayChildren[6].style.animationName = "shake-lentera"
        overlayChildren[7].style.animationName = "shake-lentera"
        overlayChildren[8].style.animationName = "shake-lentera"
      }, 5500);
    }
  }, 1000);
}
